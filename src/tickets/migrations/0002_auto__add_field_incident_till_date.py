...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.till_date'
        db.add_column(u'tickets_incident', 'till_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 12, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.till_date'
        db.delete_column(u'tickets_incident', 'till_date')
    ...
    models = {
        ...
        u'tickets.incident': {
            ...
            'till_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 7, 0, 0)'}),
